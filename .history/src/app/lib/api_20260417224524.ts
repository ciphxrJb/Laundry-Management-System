...
// Edge function is deployed as "server", while routes are namespaced with /make-server-62a04e71.
const API_BASE = `https://${projectId}.supabase.co/functions/v1/server/make-server-62a04e71`;
